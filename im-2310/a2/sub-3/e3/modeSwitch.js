...
let darkCol = "#6b118f";
let lightCol = "#f6ffef";
let linkLightCol = "#9c00da";
let linkDarkCol = "#ebc0fc";
...
if(window.matchMedia("(prefers-color-scheme: dark)").matches){
  ...
  document.documentElement.style.setProperty("--col-05", linkDarkCol);
...
function switchModes(){
  ...
  if (isDark){
    ...
    document.documentElement.style.setProperty("--col-05", linkLightCol);
