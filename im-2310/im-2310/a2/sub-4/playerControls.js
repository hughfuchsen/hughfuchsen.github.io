...
function muteUnmute() {
  ...
  if (videoElement.muted) {
    ...
    // then make sure the icon on the button changes to mute indicating what it does if you click it
...
function playbackRateChange() {
  ...
  if (videoElement.playbackRate == 1) {
    // if playback isn't already sped up make it speed up
    videoElement.playbackRate = 1.5;
    // then make sure the icon on the button changes to doubletime indicating what it does if you click it
    playbackRateButton.style.backgroundImage = "url('./icons/walking.svg')";
  } else {
    // if it isn't already muted make it mute
    videoElement.playbackRate = 1;
    // then make sure the icon on the button changes to regulartime indicating what it does if you click it
    playbackRateButton.style.backgroundImage = "url('./icons/running.svg')";
  }
}

playbackRateButton.addEventListener('click', playbackRateChange);
